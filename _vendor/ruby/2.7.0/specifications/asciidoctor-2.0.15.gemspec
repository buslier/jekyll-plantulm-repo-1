# -*- encoding: utf-8 -*-
# stub: asciidoctor 2.0.15 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_development_dependency(%q<asciimath>.freeze, ["~> 2.0.0"])
    ...
    s.add_development_dependency(%q<rouge>.freeze, ["~> 3.26.0"])
    ...
    s.add_dependency(%q<asciimath>.freeze, ["~> 2.0.0"])
